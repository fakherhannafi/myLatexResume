...
\photo[circle,edge,right]{Capture}
\name{Fakher}{HANNAFI}
\position{Full Stack Developer{\enskip\cdotp\enskip}Software Engineer{\enskip\cdotp\enskip}Scrum Master}
\address{24 years old \newline 19 Rue Tour De L'eau, 38400 Saint Martin d'Hères, Grenoble France}
